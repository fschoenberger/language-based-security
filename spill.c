...
static void aggreg(Blk* hd, Blk* b)
{
    int k;
...
static void tmpuse(Ref r, int use, int loop, Fn* fn)
{
    Mem* m;
    Tmp* t;
...
static int tcmp1(const void* pa, const void* pb)
{
    int c;
 ...
 * cost
 */
static void limit(BSet* b, int k, BSet* f)
{
 ...
 * currently in use
 */
static void limit2(BSet* b1, int k1, int k2, BSet* f)
{
    BSet b2[1];
...
static void sethint(BSet* u, bits r)
{
    int t;
 ...
 */
static void reloads(BSet* u, BSet* v)
{
    int t;
...
static Ins* dopm(Blk* b, Ins* i, BSet* v)
{
    int n, t;
    BSet u[1];
    Ins* i1;
...
static void merge(BSet* u, Blk* bu, BSet* v, Blk* bv)
{
    int t;
